function addVideo() {
    ...
    btn.forEach(item => {
      item.addEventListener('click', function() {
        ...
        //end
          ...
          let vurl=this.dataset.videourl;
        ...
        `*/
          ...
          /*parent.innerHTML = `
          <div style="padding:75% 0 0 0;position:relative;"><iframe src="${vurl}" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;"></iframe></div>
          `*/
          
          /*parent.innerHTML = `
          <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="${vurl}" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;"></iframe></div>
          `*/
  ...
  function order() {
      ...
      function output() {
          ...
          yt.textContent = `$${(price).toFixed(2)}`
      }
  ...
  var forms = function () {
    ...
    function link() {
        ...
        const all_create_order_a=document.querySelectorAll('.create_order_a');
      all_create_order_a.forEach(
        (create_order_a) => {
          
          create_order_a.addEventListener('click', function(e) {
